...
public class TbJob {
    ...
    private TbError tbError;

    private TbJobCount tbJobCount;
    ...
    public TbJobCount getTbJobCount() {
        return tbJobCount;
    }

    public void setTbJobCount(TbJobCount tbJobCount) {
        this.tbJobCount = tbJobCount;
    }

    public TbError getTbError() {
        return tbError;
    }

    public void setTbError(TbError tbError) {
